...
#define SAADC_SAMPLE_INTERVAL_US 1
...
#endif
static nrfx_saadc_channel_t channel = SAADC_CHANNEL_SE_ACQ_3US(SAADC_INPUT_PIN, 0);
...
static void saadc_event_handler(nrfx_saadc_evt_t const * p_event)
{
    ...
    switch (p_event->type)
    {
        ...
        case NRFX_SAADC_EVT_DONE:
            ...
            LOG_INF("sampling rate = %d", (4000 * 1000) / elapsed_ms);
